...
<Defs>
  ...
  <ThingDef ParentName="BuildingNaturalBase">
    <defName>ISA_PaleHive</defName>
    <label>pale hive</label>
    ...
    <graphicData>
      <texPath>Things/Building/Natural/PaleHiveTunnel</texPath>
    ...
    <comps>
      ...
      <li Class="CompProperties_SpawnerPawn">
        <spawnablePawnKinds>
          <li>ISA_PaleMegaspider</li>
          <li>ISA_PaleSpelopede</li>
		  <li>ISA_PaleHunterScarab</li>
        </spawnablePawnKinds>
  ...
  <ThingDef ParentName="EtherealThingBase">
    <defName>ISA_TunnelPaleHiveSpawner</defName>
    <label>tunnel</label>
    <thingClass>PphhyyInsects.TunnelPaleHiveSpawner</thingClass>
    <tickerType>Normal</tickerType>
  ...
  <ThingDef ParentName="EtherealThingBase">
    <defName>ISA_TunnelHiveSpawner</defName>
    <label>tunnel</label>
